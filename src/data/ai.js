  ...
  "steps": [
    {
      ...
      "backendDOMNodeId": "제공된 상호작용 요소 목록에서 선택한 요소의 backendDOMNodeId(정수)",
...
7. **backendDOMNodeId**: 유저 메시지에 첨부된 상호작용 요소 목록에서 선택한 요소의 backendDOMNodeId(정수)를 그대로 응답에 포함하세요. 해당 없으면 null.
